...
beforeAll(async () => {
  ...
  await gallery(db, { id: "l1", createdAt: "2026-05-07", h3: "8a3969a40a47fff", locality: "Lisbon", country: "PT", items: { l1a: 0 } });
  await gallery(db, { id: "l2", createdAt: "2026-05-08", h3: "8a3969a40a47fff", locality: "Lisbon", country: "PT", items: { l2a: 0 } });
  await gallery(db, { id: "l3", createdAt: "2026-05-09", h3: "8a3969a41b0ffff", locality: "Lisbon", region: "Lisbon", country: "PT", items: { l3a: 0 } });
  ...
  await gallery(db, { id: "s1", createdAt: "2026-05-10", h3: "8a2a1072b59ffff", locality: "Springfield", region: "Illinois", country: "US", items: { s1a: 0 } });
  await gallery(db, { id: "s2", createdAt: "2026-05-11", h3: "8a2a1072b5bffff", locality: "Springfield", region: "Missouri", country: "US", items: { s2a: 0 } });
  await gallery(db, { id: "s3", createdAt: "2026-05-12", h3: "8a2a1072b5affff", locality: "Springfield", country: "US", items: { s3a: 0 } });
});
